...
<img src="Панель_работы_с_контейнером.png" alt="drawing" width="200" hspace = "200"/>

Также имеется возможность двигать все фигуры на определённое количество пикселей

<img src="Перемещение всех фигур.png" alt="drawing" width="200" hspace = "200"/>

Пример работы программы:

<img src="Работа_прогрммы.png" alt="drawing" width="650" hspace = "20"/>
